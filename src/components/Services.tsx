import { Video, Users, BookOpen, Youtube, ArrowRight, CheckCircle, Star } from 'lucide-react';
      ...
      <section id="services" className="relative py-20 cinematic-section overflow-hidden border-t border-primary/20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            return <Card 
              key={index} 
              className="relative group liquid-card transition-all duration-500 cinematic-card overflow-hidden flex flex-col h-full shadow-cinematic cursor-pointer"
            ...
            borderRadius: '40px'
              ...
              <div className="relative">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <div className="text-sm text-gray-300 bg-black/40 px-3 py-1 rounded-full border border-primary/20">
